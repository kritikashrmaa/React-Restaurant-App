...
import CommonSection from '../components/UI/common-section/ComonSection'
        ...
        <Row>
          ...
          <Col lg='6' md='6'>
             <div className="single__product-content">
               ...
               <p className='category mb-05'>Category: <span>{category}</span></p>
            ...
            <Col lg='12'>
              ...
              <div className="tab__form" mb-3>
                <div className='review pt-5'>
                   <p className="user__name mb-0"> Kritika Sharma</p>
                   <p className="user__email">kritikasharma@gmail.com</p>
                ...
                <form className='form' onSubmit={submitHandler}>
                  ...
                  <div className='form__group'>
                    <textarea rows={5} type="text" placeholder='Enter Your Review' onChange={e=>setReviewMsg(e.target.value)} required/>
                  </div>
            ...
            <Col lg='12' className='mb-5 mt-4'>
              <h2 className='related__product-text'>You Might Also Like</h2>
            </Col>
